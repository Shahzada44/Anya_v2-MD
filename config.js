...
module.exports = {
     ...
     */
    ownername: process.env.Owner_Name || "SHAHZADA-BALOCH",
    ownernumber: process.env.Owner_Number || "923033065965",
    ...
    sessionId: process.env.SESSION_ID || "NG1yaDh_Queen-Anya_h_Queen-Anya_MWk=",
